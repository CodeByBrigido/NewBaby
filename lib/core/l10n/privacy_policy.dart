...
const List<PrivacySection> privacyPolicyPt = <PrivacySection>[
  ...
  PrivacySection(
    ...
    body: <String>[
      ...
      'Estar estabelecido dentro da União Europeia tem duas consequências '
          ...
          'por extensão: não há discussão sobre alcance. A segunda é que a '
          'autoridade principal é a Comissão de Proteção de Dados da Irlanda, '
          'pelo mecanismo de balcão único do Art. 56 do GDPR, e você pode '
          'reclamar tanto a ela quanto à autoridade do seu próprio país.',
  ...
  PrivacySection(
    ...
    body: <String>[
      'Registrar a própria família é, na linguagem do GDPR, uma "atividade '
          'exclusivamente pessoal ou doméstica" (Art. 2(2)(c)). Isso quer '
          'dizer que, ao guardar a memória do seu filho, **você não se torna '
          'controlador de dados pessoais perante a lei**, e não assume '
          'nenhuma das obrigações que a lei impõe a uma empresa. Você '
          'continua sendo só o pai, a mãe ou o responsável, registrando a '
          'própria criança.',
      'O aplicativo é para esse uso: pessoal e familiar, sem fim comercial. '
          'Usá-lo para registrar crianças que não são suas nem estão sob sua '
          'responsabilidade legal, ou para oferecer este serviço a terceiros, '
          'foge do que os planos cobrem.',
      'Nós temos dois papéis diferentes, e eles não se misturam. Para o '
          'índice (o cadastro, a linha do tempo, o texto das cartas), somos '
          'controlador, no sentido do Art. 4(7) do GDPR: decidimos como esse '
          'índice é tratado, e respondemos por ele. Para os seus arquivos no '
          'Google Drive, não somos nada: eles vão do seu aparelho direto para '
          'a sua própria conta do Google, por uma autorização que você dá '
          'diretamente a ela, e nós nunca recebemos cópia, nunca vemos e não '
          'temos como acessá-los. Ali, a sua relação é com o Google, e a '
          'nossa função é só a de um programa que opera com a sua permissão.',
    ],
  ),
  PrivacySection(
  ...
  PrivacySection(
    ...
    body: <String>[
      ...
      'O GDPR exige, no Art. 28, um contrato por escrito entre controlador e '
          'operador antes de qualquer tratamento. Esse contrato existe: é o '
          'Cloud Data Processing Addendum do Google, aceito ao usar o Google '
          'Cloud e o Firebase, e cobre exatamente os serviços listados acima.',
    ],
  ),
  PrivacySection(
  ...
  PrivacySection(
    ...
    body: <String>[
      ...
      '• Estados Unidos: a Califórnia tem a lei mais exigente (CCPA e CPRA, '
          ...
          'com os mesmos direitos de saber, apagar, corrigir, portar e '
          'recusar venda ou compartilhamento. Como não vendemos nem '
      ...
      '• Suíça: nLPD. Canadá: PIPEDA. Austrália: Privacy Act e os Australian '
          'Privacy Principles. África do Sul: POPIA. Japão: APPI. Índia: '
          'DPDPA, a partir da entrada em vigor de cada dispositivo.',
  ...
  PrivacySection(
    ...
    body: <String>[
      ...
      'Se acontecer uma violação de dados que afete o índice, notificamos a '
          'Comissão de Proteção de Dados da Irlanda em até 72 horas depois de '
          'sabermos, como manda o Art. 33 do GDPR, e avisamos você '
  ...
  PrivacySection(
    ...
    body: <String>[
      'Se você acreditar que o tratamento dos seus dados viola a lei, pode '
          ...
          'conosco antes.',
      '• Autoridade principal, para qualquer pessoa: Data Protection '
          'Commission da Irlanda, dataprotection.ie, que é a do lugar onde o '
          'responsável está estabelecido.',
